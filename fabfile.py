"""
Starter fabfile for deploying the django_project project.
...
# CHANGEME
env.hosts = ['user@django_project.example.com']
env.code_dir = '/srv/www/django_project'
env.project_dir = '/srv/www/django_project/django_project'
env.static_root = '/srv/www/django_project/static/'
env.virtualenv = '/srv/www/django_project/.virtualenv'
env.code_repo = 'git@github.com:user/django_project.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/django_project/wsgi.py" % env.code_dir)
